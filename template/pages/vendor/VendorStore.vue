<template>
  <v-container class="mt-6">
      <v-row>
          <v-col cols="12">
              <base-card>
                <v-img height="202" :src="require('@/assets/images/banners/shop-cover.png')"></v-img>
                <v-card-text class="p-relative">
                    <div class="d-flex justify-space-between flex-wrap mt--66">
                        
                        <div class="d-flex flex-wrap">
                            <v-avatar size="120" class="mr-8">
                                <img class="border-4-white" src="@/assets/images/faces/2.jpg" alt="">
                            </v-avatar>
                            <div>
                                <v-alert
                                    dense
                                ...
                                <div class="d-flex align-center mb-2">
                                    <v-icon small class="mr-2" color="grey darken-1">mdi-map-marker</v-icon>
                                    <span class="grey--text text--darken-1">845 N. Stonybrook Ave. Tonawanda, NY 14210, Denmark</span>
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <v-icon small class="mr-2" color="grey darken-1">mdi-phone</v-icon>
                                    <span class="grey--text text--darken-1">(613) 343-9004</span>
                                </div>
                            </div>
                        </div>
